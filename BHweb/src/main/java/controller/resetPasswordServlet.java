...
public class resetPasswordServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        if (cred == null || cred.username == null || cred.username.trim().isEmpty() ||
            cred.phone == null || cred.phone.trim().isEmpty() ||
        ...
        if (u == null || !u.getPhone().equals(cred.phone)) {
        ...
        try {
            ...
            u.setPassword(Utils.hashPassword(cred.newPassword));
            userDAO.update(u);
            
            // GHI NHẬT KÝ HÀNH ĐỘNG ĐẶT LẠI MẬT KHẨU
            AuditLogs log = new AuditLogs(u.getId(), "RESET_PASSWORD", "Users", String.valueOf(u.getId()));
